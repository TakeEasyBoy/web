...
QZFL.lazyLoad = (function() {
    ...
    cb,
    delay = 30,
    hide_img_def = 'hide_init_src',
    init_src_def = 'init_src',
    arr_df_tag = ['img', 'iframe'],
    doc_body,
    doc_element,
    $E = QZFL.event;
    function _onChange() { (typeof cb == 'function') && (cb(elems, hide_elems)); ! timer && (timer = setTimeout(_load, delay));
    };
    ...
    function init(obj) {
        ...
        elems = [];
        hide_elems = [];
        count = 0; (typeof obj['beforeCb'] == 'function') && (obj['beforeCb']());
        ...
        (typeof obj['afterCb'] == 'function') && (obj['afterCb'](elems, hide_elems)); (typeof obj['changeCb'] == 'function') && (cb = obj['changeCb']);
        $E.addEvent(window, "scroll", _onChange);
        $E.addEvent(window, "resize", _onChange);
        _load();
        var lazyTime = obj['lazyTime'] || 0; (lazyTime > 0) && (setTimeout(function() {
            _load(true);
        },
        lazyTime * 1000));
    };
    ...
    return {
        close: function() {
            if (_pt2) {
                ...
                _mask_obj && (_mask_obj.style.display = "none"); (typeof _afterClose == 'function') && _afterClose(_pt2);
            }
        },
        resize: function(w, h) {
            if (_pt2) { (typeof _beforeResize == 'function') && _beforeResize(_pt2);
                _valid = true;
                _w = w;
                _h = h;
                ...
                _setCenter(w, h); (typeof _afterResize == 'function') && _afterResize(_pt2);
            }
        },
        open: function(obj) {
            obj = obj || {};
            ...
            var appid = obj.appId || '8000212'; (typeof obj.onLoginCb == 'function') && (window.ptlogin2_onLogin = obj.onLoginCb); (typeof obj.onResetCb == 'function') && (window.ptlogin2_onReset = obj.onResetCb); (typeof obj.onSuccessCb == 'function') && (window.ptlogin2_onSuccess = obj.onSuccessCb); (typeof obj.afterClose == 'function') && (_afterClose = obj.afterClose); (typeof obj.beforeResize == 'function') && (_beforeResize = obj.beforeResize); (typeof obj.afterResize == 'function') && (_afterResize = obj.afterResize);
            ...
            }; (typeof obj.style != 'undefined') && (objParm['style'] = obj.style); (typeof obj.hideTitleBar != 'undefined') && (objParm['hide_title_bar'] = obj.hideTitleBar); (typeof obj.hideCloseIcon != 'undefined') && (objParm['hide_close_icon'] = obj.hideCloseIcon); (typeof obj.bgColor != 'undefined') && (objParm['bgcolor'] = obj.bgColor); (typeof obj.bgImage != 'undefined') && (objParm['bgimage'] = obj.bgImage); (typeof obj.fontColor != 'undefined') && (objParm['fontcolor'] = obj.fontColor); (typeof obj.title != 'undefined') && (objParm['title'] = obj.title); (typeof obj.loginText != 'undefined') && (objParm['login_text'] = obj.loginText); (typeof obj.loginImg != 'undefined') && (objParm['login_img'] = obj.loginImg); (typeof obj.resetImg != 'undefined') && (objParm['reset_img'] = obj.resetImg); (typeof obj.uin != 'undefined') && (objParm['uin'] = obj.uin); (typeof obj.hideUinTip != 'undefined') && (objParm['hide_uin_tip'] = obj.hideUinTip);
            if (isQuick) {
